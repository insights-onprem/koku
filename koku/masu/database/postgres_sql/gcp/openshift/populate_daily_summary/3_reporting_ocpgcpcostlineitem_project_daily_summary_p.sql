INSERT INTO {{schema | sqlsafe}}.reporting_ocpgcpcostlineitem_project_daily_summary_p (
    uuid,
    report_period_id,
    cluster_id,
    cluster_alias,
...
filtered_data as (
    SELECT
        ...
        persistentvolume,
        storageclass,
        {{schema | sqlsafe}}.filter_json_by_keys(pod_labels, pek.keys)::json AS enabled_labels,
